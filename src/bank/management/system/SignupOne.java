...
public class SignupOne extends JFrame implements ActionListener {
    long random;
    JTextField nameTextField, fnameTextField, dobTextField, emailTextField, addressTextField, cityTextField, districtTextField, zipTextField;
    JButton next;
    ...
    SignupOne() {
        ...
        zipTextField.setFont(new Font("Railway", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (name.equals("")){
                ...
                Conn c = new Conn();
                String query  = "insert into signup values('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+zip+"', '"+district+"')";
